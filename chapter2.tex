...
\begin{proof}
  ...
  If $u \in L^p(\Omega)$ and $\varepsilon>0$, there exists $\phi \in C_0(\Omega)$ such that $\|u-\phi\|_p<\varepsilon / 2$. If $1 / m<\operatorname{dist}(\operatorname{supp}(\phi)$, bdry $(\Omega))$, then there exists $f$ in the set $P_m$ such that $\|\phi-f\|_{\infty}<(\varepsilon / 2)\left(\operatorname{vol}\left(\Omega_m\right)\right)^{-1 / p}$. It follows that
  \[
  \|\phi-f\|_p \leq\|\phi-f\|_{\infty}\left(\operatorname{vol}\left(\Omega_m\right)\right)^{1 / p}<\varepsilon / 2
  \]
...
\begin{theorem}[Properties of Mollification]
  ...
  \begin{enumerate}[label = (\alph*)]
    ...
    \item If $u \in L_{\mathrm{loc}}^1(\Omega)$ and $\operatorname{supp}(u) \subset\subset \Omega$, then $J_\varepsilon * u \in C_0^{\infty}(\Omega)$ provided
    \[
    \varepsilon<\operatorname{dist}(\operatorname{supp}(u), \operatorname{bdry}(\Omega))
    \]
    ...
    \item If $u \in C(\bar{\Omega})$, then $\lim _{\varepsilon \rightarrow 0+} J_\varepsilon * u(x)=u(x)$ uniformly on $\Omega$.
  \end{enumerate}
\end{theorem}
...
\begin{proof}
  ...
  \end{aligned}
  \]
  Since $\phi$ is uniformly continuous on $\Omega$, the right side of (20) tends to zero as $\varepsilon \rightarrow 0+$. Since $\operatorname{supp}(\phi)$ is compact, we can ensure that $\left\|J_\varepsilon * \phi-\phi\right\|_p<\eta / 3$
...
\begin{proof}
  ...
  \[
  \left|\psi_j(x)-J_\eta * u(x)\right|<\frac{\varepsilon}{3 \cdot 2^{p-1} \cdot \operatorname{vol}(\bar{G})}
  \]
  ...
  &<\frac{\varepsilon}{3}+2^{p-1}\left(\frac{\varepsilon}{3 \cdot 2^{p-1}}+\frac{\varepsilon}{3 \cdot 2^{p-1} \cdot \operatorname{vol}(\bar{G})} \operatorname{vol}(\bar{G})\right)=\varepsilon
  \end{aligned}
  \]
